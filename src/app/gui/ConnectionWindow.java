...
public class ConnectionWindow extends JFrame
{
	...
	{	
		...
		JLabel lblTitle = new JLabel("Patient Ressources Everywhere");
	...
	class ConnectButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent arg0) {
			try {
				...
				{
					lblStatus.setText("Connexion impossible");
					lblStatus2.setText("Nom d'utilisateur ou mot de passe incorrect");
					txtLogin.requestFocus();
				}
			} catch (SQLException | NullPointerException e) {
				lblStatus.setText("Erreur interne de connexion");
				lblStatus2.setText("Configuration base de données incorrecte");
			}
		}
	}
}
